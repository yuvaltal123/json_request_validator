import unittest
from validator import RequestValidator, TypeValidator


class TestTypeValidations(unittest.TestCase):
    """ Testing single type validations"""
    ...
    def test_valid_emails(self):
        ...
        for valid_email in valid_emails:
            validator_result = TypeValidator._is_valid_email(valid_email)
    ...
    def test_valid_auth_tokens(self):
        ...
        for token in valid_auth_tokens:
            validator_result = TypeValidator._is_valid_auth_token(token)
            self.assertEqual(True, validator_result)
    ...
    def test_valid_dates(self):
        ...
        for date in valid_dates:
            validator_result = TypeValidator._is_valid_date(date)
            self.assertEqual(True, validator_result)
    ...
    def test_valid_py_types(self):
        ...
        for val, py_type in zip(vals, py_types):
            validator_result = TypeValidator._is_valid_py_type(val, py_type)
            self.assertEqual(True, validator_result)
